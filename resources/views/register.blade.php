@extends('layouts.app')
@section('content')
<div class="flex justify-center	content-center h-[480px]">
    <form class="sm:w-[500px] md:w-[600px] bg-white border-gray-500 border rounded px-8 pt-6 pb-8 mb-4 m-auto" method="post" action="register">
      ...
      <div class="flex items-center justify-between">
        ...
        <a class="inline-block align-baseline font-bold text-sm text-purple-500 hover:text-purple-800" href="/public/login">
